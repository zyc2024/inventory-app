...
export default function Home() {
    ...
    // filter the data according to user's search before rendering
    const filteredInventory = inventory.filter(({ name, _ }) => {
        return name.toString().toLowerCase().includes(searchName.toLowerCase());
    });
